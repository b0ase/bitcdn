...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-6 md:p-8 text-center bg-black text-white overflow-hidden">
      <div className="w-full flex flex-col items-center justify-center">
        <Image
          ...
          width={80}
          height={80}
          className="mx-auto mb-3 shadow-lg bg-gray-800 rounded-full"
        />
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-4 w-full max-w-4xl">
          <div className="bg-gray-800 p-3 sm:p-4 rounded-lg shadow-xl">
            ...
            <ul className="list-disc list-inside text-left text-xs sm:text-sm text-gray-300 space-y-1">
