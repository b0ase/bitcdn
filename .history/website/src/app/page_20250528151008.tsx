  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8 sm:p-16 md:p-24 text-center bg-gray-900 text-white">
      <div className="w-full">
        <Image
          src="/placeholder-logo.svg" // Replace with an actual logo if you have one
          alt="BitCDN Logo"
          width={150}
          height={150}
          className="mx-auto mb-8 rounded-full shadow-lg" // Basic styling for a placeholder
        />
        ...
        <div className="bg-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl mb-12">
          ...
          <p className="text-lg text-gray-400 leading-relaxed">
            ...
            Say goodbye to centralized bottlenecks and censorship risks.
          </p>
        </div>
        ...
        <div className="bg-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl mb-12">
          ...
          <p className="text-lg text-gray-400 leading-relaxed mb-4">
            We believe in fair compensation for creators and contributors.
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-800 p-6 rounded-xl shadow-xl">
            ...
            <ul className="list-disc list-inside text-left text-gray-400 space-y-2">
              ...
              <li>
                <strong className="text-orange-300">Censorship Resistant:</strong> Content distributed globally by peers.
              </li>
              <li>
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow-xl">
            ...
            <p className="text-gray-400 mb-4">
              ...
              towards a more open, fair, and efficient internet.
            </p>
