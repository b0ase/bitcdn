  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-6 md:p-8 text-center bg-white text-black overflow-hidden">
      <div className="w-full flex flex-col items-center justify-center">
        ...
        />
        <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-600">
          BitCDN
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-4 w-full max-w-4xl">
          <div className="bg-gray-100 p-3 sm:p-4 rounded-lg shadow-xl">
            <h2 className="text-xl font-semibold mb-1 text-orange-600">
              Peer-to-Peer Power
            </h2>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-4 w-full max-w-4xl">
          <div className="bg-gray-100 p-3 sm:p-4 rounded-lg shadow-xl">
            <h3 className="text-lg font-semibold mb-1 text-orange-600">Why BitCDN?</h3>
            <ul className="list-disc list-inside text-left text-xs sm:text-sm text-gray-600 space-y-1">
              <li><strong className="text-orange-500">Decentralized:</strong> No single point of failure.</li>
              <li><strong className="text-orange-500">Creator Focused:</strong> Earn BSV for your content.</li>
              <li><strong className="text-orange-500">Cost-Effective:</strong> Lower bandwidth costs.</li>
              <li><strong className="text-orange-500">Transparent:</strong> BSV blockchain for interactions.</li>
            </ul>
          </div>
          <div className="bg-gray-100 p-3 sm:p-4 rounded-lg shadow-xl flex flex-col items-center justify-center">
            <h3 className="text-lg font-semibold mb-1 text-orange-600">Join the Revolution</h3>
